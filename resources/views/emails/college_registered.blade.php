...
<div class="portal" style="gap: 16px;">
  <div style="flex: 1; min-width: 0;">
    <div class="portal-label">College Portal</div>
    <a href="{{ $loginUrl }}" class="portal-url" style="word-break: break-all;">{{ $loginUrl }}</a>
  </div>
  <a href="{{ $loginUrl }}" class="btn" style="margin-left: 12px; flex-shrink: 0;">Login →</a>
</div>
    {{-- Warning --}}
    <div class="alert">
