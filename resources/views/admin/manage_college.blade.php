...
<div class="d-flex justify-content-between align-items-center mb-3">
    <form method="GET" action="{{ route('admin.college.index') }}" class="d-flex gap-2 w-100">
        <input
            type="text"
            name="search"
            class="form-control"
        ...
        >
        <button type="submit" class="btn btn-primary" style="background-color:#306060; border-color:#306060;">
            <i class="fas fa-search"></i> Search
        </button>
        @if(request('search'))
            <a href="{{ route('admin.college.index') }}" class="btn btn-outline-secondary">
                    ...
                    <div class="row g-3">
                        ...
                        {{-- Rating --}}
                            <div class="col-md-4">
                                ...
                                <input type="number" step="0.1" min="0" max="5" name="rating"
                                    id="edit_rating" class="form-control">
                            </div>
                        ...
                        <!-- Row 3 -->
                            ...
                            <div class="col-md-6">
                                ...
                                <small class="text-muted">Include https:// or http://</small>
                            </div>
                        <!-- Row 4 -->
                        <div class="col-12">
...
function addFacility(value = '') {
    ...
    div.innerHTML = `
        <input type="text" name="facilities[]" class="form-control"
               value="${value}" placeholder="Enter facility name">
...
function addCourse(value = '') {
    ...
    div.innerHTML = `
        <input type="text" name="courses[]" class="form-control"
               value="${value}" placeholder="Enter course name">
        <button type="button" class="btn btn-outline-danger"
