...
@push('scripts')
    <script>
        console.log('Edit College Script Loaded');
    ...
    `;
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            modalElement.addEventListener('show.bs.modal', function(event) {
                ...
                const imagesJson = button.getAttribute('data-images'); // ✅ ADD THIS
                ...
                document.getElementById('edit_street').value = locationParts[0] || '';
                document.getElementById('edit_district').value = locationParts[1] || '';
                document.getElementById('edit_state').value = locationParts[2] || '';
                ...
                try {
                    ...
                    facilities.length ?
                        facilities.forEach(f => addFacility(f)) :
                        addFacility();
                } catch (e) {
                    addFacility();
                }
