                        ...
                        <form action="{{ route('admin.career_nodes.store') }}" method="POST" enctype="multipart/form-data"
                            ...
                            <div class="mb-3">
                                ...
                                <div class="btn-group" role="group" id="mediaToggleGroup">
                                    <input type="radio" class="btn-check" name="media_type_toggle" id="toggleVideo" autocomplete="off" checked>
                                    ...
                                    <input type="radio" class="btn-check" name="media_type_toggle" id="toggleThumbnail" autocomplete="off">
                                ...
                                <small class="text-muted d-block mt-1">Choose to provide a YouTube video URL or upload a thumbnail image.</small>
                            </div>
