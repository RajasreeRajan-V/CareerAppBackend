                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password"
                               ...
                               required
                               minlength="8"
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 {{ $errors->has('new_password') ? 'border-red-400' : '' }}">
                        <button type="button"
                                onclick="togglePassword('new_password', 'eye1')"
                                class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-teal-600 transition-colors">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="password"
                               ...
                               required
                               class="w-full border border-gray-300 rounded-lg px-4 py-2 pr-10 text-sm focus:outline-none focus:ring-2 focus:ring-teal-500 {{ $errors->has('new_password_confirmation') ? 'border-red-400' : '' }}">
                        <button type="button"
                                onclick="togglePassword('new_password_confirmation', 'eye2')"
                                class="absolute inset-y-0 right-0 flex items-center px-3 text-gray-400 hover:text-teal-600 transition-colors">
